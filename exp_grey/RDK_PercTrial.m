...
resultpath = 'C:\Users\rothwellap\Desktop\AnticipationPerception\res';
...
%Fixation box
xsize = 400; % x-size in pixels (WE HAVE TO FIGURE OUT THE PIXEL TO DEGREES CONVERSION)
ysize = 400;
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Screen('FillRect', screenInfo.curWindow, 127);
            ...
            if Eyelink( 'NewFloatSampleAvailable') > 0
                ...
                if xeye~=el.MISSING_DATA & yeye~=el.MISSING_DATA & evt.pa(eye_used+1)>0
                   ...
                   if (diffx > 0 || diffy > 0)
                    ...
                    Screen('Flip', screenInfo.curWindow);
                    WaitSecs(0.2);
                    Screen('FillArc',screenInfo.curWindow, 127, positionOfMainCircle, 0 ,360);
                    [VBL StimulusOnsetTime] = Screen('Flip', screenInfo.curWindow);
                    WaitSecs(0.1);
                    % SkipTrial = 1;
                    FixTime = 0;
 ...
 %%%%%%%%%%%%%%%%%%%%%%%% RESPONSE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    aperature = Screen('OpenOffscreenwindow', screenInfo.curWindow, 127, screenInfo.screenRect);
    Screen('FillOval', aperature, [255 255 255 100], objCirc);

    
    %Screen('FillRect', screenInfo.curWindow, 127);
    noise = round(rand(500,500))*255;
    noiseTexture = Screen('MakeTexture', screenInfo.curWindow, noise);
    Screen('DrawTextures', screenInfo.curWindow, noiseTexture);
