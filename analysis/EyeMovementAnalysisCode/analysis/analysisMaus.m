...
%                 motionDprevious(pI, 1) = sum(eyeTrialData.choice(subN, idxP(pI)-windowSize:idxP(pI)-1))/windowSize; % based on participant's choice
                motionDprevious(pI, 1) = sum(eyeTrialData.rdkDir(subN, idxP(pI)-windowSize:idxP(pI)-1))/windowSize; % based on visual motion
