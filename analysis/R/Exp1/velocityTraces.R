...
dataFileName <- "velocityTrace_wrongPerceptualPerceived_exp1_prob"
pdfFileName <- "velocityTracePerceptual_wrongPerceptualPerceived_all_Exp1.pdf"
# dataFileName <- "slidingW_perceptionRatio_"
# pdfFileName <- "slidingW_perceptionRatio_STE_all_Exp1.pdf"
