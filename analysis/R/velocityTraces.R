...
pdfFileName <- "slidingWindowChoicePerceptual_all_Exp2.pdf"
# for plotting
...
#         geom_line(data = velTrace[[3]], aes(x = timePoints, y = velMean, colour = "90%"), size = 1, linetype = "twodash") + geom_ribbon(data = velTrace[[3]], aes(x = timePoints, ymin=velLower, ymax=velUpper, fill = "90%"), alpha = velAlpha) +
#         geom_line(data = velTrace[[4]], aes(x = timePoints, y = velMean, colour = "90%"), size = 1, linetype = "twodash") + geom_ribbon(data = velTrace[[4]], aes(x = timePoints, ymin=velLower, ymax=velUpper, fill = "90%"), alpha = velAlpha) +
